...
var SaturnMoonsPage = {
    ...
    hostElement : document.getElementById("SaturnMoons"),
    pageRendered : false,
    ...
    displayPage : function (startJD, numberOfDays) {
        ...
        var paths = {'Mimas' : {'d' : '', 'color' : 'blue', 'lastPos' : {'X' : 0, 'Y' : 0} },
        ...
        var coords = SaturnMoonsData.getDataAsObjectForJD(currentJD, false);        
